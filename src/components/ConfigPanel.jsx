            ...
            {activeTab === 'danger' && (
              <div style={{ textAlign: 'center', padding: '2rem 0' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', maxWidth: '500px', margin: '0 auto 2rem auto', fontSize: '0.95rem' }}>
                  This will wipe all local modifications (e.g. customized packages, booked slots, address adjustments, and member data) and seed the default configuration for Modern Fitness Kluang.
                </p>
                <button 
                  className="btn btn-danger"
